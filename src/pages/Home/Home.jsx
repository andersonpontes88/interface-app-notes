...
function Home() {
  ...
  //Função mostrar informações do usuário
      ...
      <div className="container mx-auto">
        {allNotes.length > 0 ? (
          ...
          <EmptyCard
            ...
            message={
              isSearch
                ? `Oops! Nenhuma nota encontrada correspondendo à sua pesquisa`
                : `Comece a criar sua primeira nota! Clique no botão Adicionar (+) para anotar seus Pensamentos, Ideias, Lembretes e datas comemorativas Especiais. Vamos começar?`
            }
          />
        )}
      </div>
